  ...
  const handleRestore = async () => {
    ...
    try {
      const res = await fetch('/api/restore', {
        ...
        body: JSON.stringify({
          backup: parsedBackup,
          confirmCrossOrg: crossOrgConfirmed,
        }),
      })
      ...
      if (!res.ok) {
        throw new Error(data.error || 'Gabim gjatë rikuperimit')
      }
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      <PageHeader
        ...
        subtitle="Eksportoni dhe rikuperoni të dhënat e organizatës në mënyrë të sigurt"
      />
